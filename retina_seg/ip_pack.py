...
def MT_method_processing(image_array):
    ...
    # denoising
    denoised_green = WienerFilter(lab2rgb_green_channel, mysize = 3, noise = 1.5).astype('uint8')
    # Otsu
    ret2, otsu_img = cv2.threshold(denoised_green,0,255,cv2.THRESH_BINARY+cv2.THRESH_OTSU)
